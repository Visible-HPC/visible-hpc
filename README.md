# Visible HPC: Making High Performance Research Computing Visible (Again)!
...
_**We need to make research computing infrastructure visible again!**_
...
Feel free to get in touch with [Jeremy Cohen](https://profiles.imperial.ac.uk/jeremy.cohen) who is leading this work.

## Licence

The text-based content in this repository is licensed under a [CC-BY-4.0 Attribution licence](https://creativecommons.org/licenses/by/4.0/). See the [LICENSE](LICENSE) file.

Any code developed by the team that is hosted in this repository is available under a BSD-3-Clause licence unless otherwise noted. See the [LICENSE.code](LICENSE.code) file for details.
